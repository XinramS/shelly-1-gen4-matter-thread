...
// Shelly 1 Mini Gen4 wall switch input.
//
// HARDWARE NOTE: GPIO_PULLUP_DISABLE and GPIO_PULLDOWN_DISABLE are
// required. The SW terminal is routed to GPIO12 (the ESP32-C6 USB D- pin),
// and the external circuit fully defines the level. Enabling
// either internal pull will fight the external circuit and prevent the
// ISR from firing. Do not "fix" this by adding a pull.
#define SWITCH_INPUT_GPIO   GPIO_NUM_12
...
esp_err_t switch_input_init(void)
{
    ...
    // Configure GPIO12 as edge-interrupt input. See HARDWARE NOTE above
