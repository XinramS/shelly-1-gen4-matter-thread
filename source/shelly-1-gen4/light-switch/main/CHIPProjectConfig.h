...
#define CHIP_DEVICE_CONFIG_DEVICE_PRODUCT_NAME            "Shelly 1 Gen4 MoT Light Switch"
#define CHIP_DEVICE_CONFIG_DEVICE_SOFTWARE_VERSION_STRING "2.0.0"
#define CHIP_DEVICE_CONFIG_DEVICE_SOFTWARE_VERSION        0x00020000
